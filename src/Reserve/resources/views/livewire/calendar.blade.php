<div class="rounded-t">
    <div class="pt-4 pb-2 text-sm text-center bg-gray-200 rounded-t">
        日付を選択してください。本日から最大30日先まで選択できます。
        <input id="calendar" class="block mx-auto mt-1 mb-1 bg-white rounded" type="text" name="calendar" value="{{ $currentDate }}"
